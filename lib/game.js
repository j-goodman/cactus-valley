...
instantiateWorld = () => {
    ...
    game.grid[6][16].entities = []
    cliffGap = new Cliff (6, 16)
    cliffGap.icon = game.icons['cliff_o']
    cliffGap.solid = false

    game.grid[10][16].entities = []
    cliffGap = new Cliff (10, 16)
    cliffGap.icon = game.icons['cliff_p']
    cliffGap.solid = false
...
Well.prototype.action = function () {
    let surroundings = this.checkSurroundings(3)
