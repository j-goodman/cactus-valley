...
let loadSprites = () => {
    ...
    let ram_run_up = new Image ()
    let ram_run_right = new Image ()
    let ram_run_down = new Image ()
    let ram_run_left = new Image ()
    let ram_stand_up = new Image ()
    let ram_stand_right = new Image ()
    let ram_stand_down = new Image ()
    let ram_stand_left = new Image ()
    ram_run_up.src = 'assets/sprites/ram_run_up.png'
    ram_run_right.src = 'assets/sprites/ram_run_right.png'
    ram_run_down.src = 'assets/sprites/ram_run_down.png'
    ram_run_left.src = 'assets/sprites/ram_run_left.png'
    ram_stand_up.src = 'assets/sprites/ram_stand_up.png'
    ram_stand_right.src = 'assets/sprites/ram_stand_right.png'
    ram_stand_down.src = 'assets/sprites/ram_stand_down.png'
    ram_stand_left.src = 'assets/sprites/ram_stand_left.png'
    allImages.push(ram_run_up)
    game.spriteSets.ram = {
        'run_up': new Sprite (ram_run_up, 6, 132, -14, 0),
        'run_right': new Sprite (ram_run_right, 6, 132, -14, 0),
        'run_down': new Sprite (ram_run_down, 6, 132, -14, 0),
        'run_left': new Sprite (ram_run_left, 6, 132, -14, 0),
        'stand_up': new Sprite (ram_stand_up, 1, 132, -14, 0),
        'stand_right': new Sprite (ram_stand_right, 1, 132, -14, 0),
        'stand_down': new Sprite (ram_stand_down, 1, 132, -14, 0),
        'stand_left': new Sprite (ram_stand_left, 1, 132, -14, 0),
    }
}
